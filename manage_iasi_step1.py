...
"""
    ...
    pixels will be saved. Call this script via "python3 manage_iasi.py". Subfolders may be useful
    to split the IASI data into smaller packages to be more managable (i.e., 5 days per subfolder).
